    ...
    <form method="POST" wire:submit.prevent="store">
                                    ...
                                    <td class="text-sm font-medium text-gray-900 px-2 py-2">
                                        @if ($type_paiement)
                                            <p class="text-sm font-medium text-green-500 mb-1">
                                                {{ __('Méthode') }}: {{ $type_paiement->meth_nom }}
                                            </p>
                                        @endif
                            ...
                            <tbody>
                                @foreach ($vgs as $index => $vg)
                                    ...
                                    <tr class="align-middle border-b border-gray-200">
                                        ...
                                        <td class="text-sm font-medium text-gray-900 px-2 py-2">
                                            <input type="text"
                                                   class="w-20 block mx-auto rounded-md border-gray-300 bg-gray-100 text-center @error('vgs.'.$index.'.ve_prix_vente') border-red-500 bg-red-100 @enderror"
                                        ...
                                        <td class="text-sm font-medium text-gray-900 px-2 py-2">
                                            <input type="text"
                                                   class="w-20 block mx-auto rounded-md border-gray-300 bg-gray-100 text-center font-bold text-green-600 @error('vgs.'.$index.'.ve_prix_tot') border-red-500 bg-red-100 @enderror"
        ...
        <div class="bg-gray-50 p-4 rounded-lg border">
            <div class="flex flex-wrap items-center justify-between gap-4">
                ...
                @if ($compteur_remise)
                    <div class="flex flex-col space-y-2 bg-white p-3 rounded-lg border">
                        <label class="flex items-center">
                            ...
                            <input type="number"
                                   class="w-16 rounded-md border-gray-300 text-sm @error('remise') border-red-500 bg-red-100 @enderror"
                        ...
                        <label class="flex items-center">
                            ...
                            <input type="number"
                                   class="w-24 rounded-md border-gray-300 text-sm @error('remise2') border-red-500 bg-red-100 @enderror"
                ...
                <!-- Bouton Annuler -->
                <a href="{{ route('ventes.index') }}" class="bg-red-600 hover:bg-red-700 rounded-lg px-6 py-3 text-white font-semibold transition shadow">
                    {{ __('Annuler') }}
                </a>
            </div>
        </div>
